...
//
//! \class	B3YenaCore  
//! \brief	Yena SWR 엔진 기반 클래스  
//! 
//! Yena 구현 클래스 기능 확장용 기반 클래스
//!  - 공통 데이터 운용
//!  - 공통 인터페이스 제공
//! 
//! \code 
//! <파생 클래스>
//!  - B3YenaGraphics
//!  - B3YenaGraphicsEngine9/10/11/12/GL/VK	//그래픽스 엔진
...
protected:
	...
	virtual int  _HomogeneousDivide	(B3YXVECTOR4 iPos[3], B3YXVECTOR3 oPos[3] );
	...
	virtual void _VLine	(HDC hdc, int x, int y1, int y2, B3YXCOLOR c0, B3YXCOLOR c1);	
	...
	//---------------------------
	// 공간 가시화 장치 (Gizmos) :  <DX> 미지원. "친절한 예나씨" 
	//---------------------------
	virtual void _DrawGrid();		//그리드 출력
	virtual void _DrawAxis();		//방향축 출력
