...
//const YNID CID_ynIUnknown = { 0x594E5357, 0xB300, 0x4458, { 0x90, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } };
const YNCLSID CLSID_Yena				= { 0x594E5357, 0xB300, 0x4458, { 0x90, 0x59, 0x42, 0x00, 0x00, 0x00, 0x00, 0x01 } };   //!< Yena 버전 : 0x09 + 0x01~FF (8bit)
const YNCLSID CLSID_YenaDevice9			= { 0x594E5357, 0xB300, 0x4458, { 0x90, 0x44, 0x56, 0x00, 0x00, 0x00, 0x00, 0x01 } };   //!< YenaDevice 버전 : 0x09 + 0x01~0xFF (8bit)
const YNCLSID CLSID_YenaVertexBuffer9	= { 0x594E5357, 0xB300, 0x4458, { 0x90, 0x56, 0x42, 0x00, 0x00, 0x00, 0x00, 0x01 } };   //!< YenaVB 버전 :  0x09 + 0x010~0xFF (8bit) 
